...
$today = date("Y-m-d H:i:s"); 
    ...
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if($lavage_montant > $solde){
            ...
            if(!empty($code_centre) AND !empty($type_service) AND !empty($numero_telephone)){
                    ...
                    $sql = "INSERT INTO triton_wallet_operation (id_service, id_wallet_utilisateur, solde_avant_utilisateur, montant_operation, solde_apres_utilisateur, id_wallet_centre_lavage, solde_avant_centre_lavage, solde_recu_centre_lavage, solde_apres_centre_lavage, cree_le, modifier_le, etat) 
                             VALUES ('$id_service', '$numero_telephone', '$solde', '$lavage_montant', '$reste_wallet', '$id_centre_lavage', '$solde_centre_lavage', '$recu_centre_lavage', '$nouveau_solde_centre_lavage', '$today', '$today', 1)";
